...
const projects = [
    {
        id: 1,
        title: "Site para uma equipa de Voleibol",
        description: "Descrição super descritiva do Site para uma equipa de Voleibol",
    ...
    {
        id: 2,
        title: "Livraria online em Microserviços",
        description: "Descrição super descritiva da Livraria online em Microserviços",
