                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center ">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:pedro@araujopires.pt" className="text-muted-foreground hover:text-primary transition-colors">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+351934678153" className="text-muted-foreground hover:text-primary transition-colors">
                                        +(351) 934678153
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="https://www.linkedin.com/in/ppires21/" target="_blank">
                                    <Linkedin />
                                </a>
                                <a href="https://x.com/ppirs21" target="_blank">
                                    <Twitter />
                                </a>
                                <a href="https://www.instagram.com/p.pires21/" target="_blank">
                                    <Instagram />
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs">
                        ...
                        <form className="space-y-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="Pedro Pires..." />
                            </div>
