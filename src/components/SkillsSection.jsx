...
const skills = [
    ...
    { name: "XigmaNAS", level: 65, category: "devops" },
    { name: "Core (Network Sim)", level: 55, category: "devops" },
    { name: "Go", level: 50, category: "devops" },
    { name: "Outsystems", level: 50, category: "devops" },
