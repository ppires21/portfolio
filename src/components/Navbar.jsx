                ...
                <div className="container flex items-center justify-between">
                    <a className="text-xl font-bold text-primary flex items-center" href="#hero">
                        <span className="relative z-10">
                            {" "}
                            P<span className="text-glow text-foreground">edro  </span>P<span className="text-glow text-foreground">ires</span>  P<span className="text-glow text-foreground">ortfolio</span>
                        </span>
                    </a>
